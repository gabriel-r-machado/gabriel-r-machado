...
<p align="center">
  <em>Building fast, scalable and business-focused web applications.</em>
</p>
...
- Performance-focused interfaces with Core Web Vitals, SSR, ISR and caching strategies.
- Frontend architecture with React, Next.js, TypeScript and Clean Architecture principles.
- AI-powered tools using LLM APIs, structured prompts and JSON-based outputs.
- Backend projects with Java, Spring Boot, PostgreSQL, Docker and transaction rules.
